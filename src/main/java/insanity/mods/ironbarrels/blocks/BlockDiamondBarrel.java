...
public class BlockDiamondBarrel extends BlockContainer {
    ...
    public BlockDiamondBarrel() {
        super(Material.iron);
        this.setStepSound(soundTypeMetal);
        this.setHardness(3.0F);
        this.setHarvestLevel("pick", 0);
        this.setResistance(3.0F);
        this.setBlockTextureName("diamond_barrel");
        this.setBlockName("diamondBarrel");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        player.openGui(IronBarrels.instance, TileEntityDiamondBarrel.getType().ordinal(), world, x, y, z);
        return true;
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        TileEntityDiamondBarrel tileentitychest = (TileEntityDiamondBarrel) world.getTileEntity(x, y, z);
