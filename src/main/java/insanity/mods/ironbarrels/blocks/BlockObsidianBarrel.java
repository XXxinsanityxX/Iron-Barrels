...
public class BlockObsidianBarrel extends BlockContainer {
    ...
    public BlockObsidianBarrel() {
        ...
        this.setBlockTextureName("obsidian_barrel");
        this.setBlockName("obsidianBarrel");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        player.openGui(IronBarrels.instance, TileEntityObsidianBarrel.getType().ordinal(), world, x, y, z);
        return true;
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        TileEntityObsidianBarrel tileentitychest = (TileEntityObsidianBarrel) world.getTileEntity(x, y, z);
