...
public class BlockGoldBarrel extends BlockContainer {
    ...
    public BlockGoldBarrel() {
        super(Material.iron);
        this.setStepSound(soundTypeMetal);
        this.setHardness(3.0F);
        this.setHarvestLevel("pick", 0);
        this.setResistance(3.0F);
        this.setBlockTextureName("gold_barrel");
        this.setBlockName("goldBarrel");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        player.openGui(IronBarrels.instance, TileEntityGoldBarrel.getType().ordinal(), world, x, y, z);
        return true;
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        TileEntityGoldBarrel tileentitychest = (TileEntityGoldBarrel) world.getTileEntity(x, y, z);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityGoldBarrel();
    }
}