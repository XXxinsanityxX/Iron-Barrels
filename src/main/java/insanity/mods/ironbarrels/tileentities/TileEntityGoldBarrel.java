...
public class TileEntityGoldBarrel extends TileEntity implements IInventory {
    ...
    public TileEntityGoldBarrel() {
        this(IronBarrelType.GOLD);
    }

    protected TileEntityGoldBarrel(IronBarrelType type) {
        super();
        TileEntityGoldBarrel.type = type;
    ...
    public void closeInventory() {
        if (this.getBlockType() instanceof BlockGoldBarrel) {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType());
